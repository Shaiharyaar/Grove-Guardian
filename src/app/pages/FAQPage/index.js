...
const Contacts = () => {
  return (
    <div>
      ...
      <Paragraph>
        Phone number: +358 123123123
        <br />
        Email: GroveGuardian@aalto.fi
        <br />
...
const FAQPage = () => {
  return (
    <div className='faq-page'>
      ...
      <Paragraph>
        <Accordion
          question='How do I log the trees I have planted on the website?'
          answer='To log the trees you have planted, first sign in to your account, then click on the Add Tree button. Fill out the form with details such as the species of tree, quantity, and location. Once submitted, this information will be recorded in your My Contributions section.'
        />
        <Accordion
          question='How can I view all the trees I have planted?'
          answer="After signing in, click on the 'My Contributions' tab in the navigation bar to see a list of all the trees you have planted."
        />
        <Accordion
          question='Can I add photos for each tree I plant?'
          answer='Absolutely, we encourage you to add photos for each tree. You can upload one or several photos while adding or editing your tree planting entry.'
        />
        <Accordion
          question='What should I do if I find an error in my submitted tree planting record?'
          answer="If you need to correct any details, you can navigate to your 'My Contributions' page, find the respective entry, and click the edit button to make changes."
        />
      </Paragraph>
      <Help />
      <Contacts />
